    ...
    <div className='mt-5'>
        ...
        lg:grid-cols-4 gap-6 mt-5'>
            {businessList.length>0? businessList.map((business, index) => (
                <Link href={'/details/'+business.id} className=' shadow-md rounded-lg hover:shadow-lg
                hover:shadow-primary cursor-pointer hover:scale-105 transition-all ease-in-out' key={index}>
                    ...
                    <div className='flex flex-col items-baseline p-3 gap-1'>
                        ...
                        text-primary rounded-full px-2 text-[12px]'>{business.category.name}</h2>
            ...
            [1,2,3,4,5,6,7,8].map((item, index)=>(
                <div className='h-[300px] w-full bg-slate-200 animate-pulse
                rounded-lg'>
